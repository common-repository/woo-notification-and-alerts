<?php
abstract class viewWns extends baseObjectWns {
    /*
     * @deprecated
     */
    protected $_tpl = WNS_DEFAULT;
    /*
	...
	public function getPath($tpl) {
		$path = '';
		$parentModule = frameWns::_()->getModule( $this->_code );
	...
	public function getModel($code = '') {
		return frameWns::_()->getModule( $this->_code )->getController()->getModel($code);
	}
